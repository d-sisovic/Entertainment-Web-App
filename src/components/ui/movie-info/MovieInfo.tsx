...
const MovieInfo = ({ movie, isTrending }: IMovieInfoProps) => {
    const titleStyles = isTrending ? "text-[0.938rem]/[1.188rem]" : "text-[0.875rem]/[1.125rem]";
    const containerStyles = isTrending ? "text-[0.75rem]/[0.938rem] gap-2" : "text-[0.688rem]/[0.875rem] gap-1.5";
